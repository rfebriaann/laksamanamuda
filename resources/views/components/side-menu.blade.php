        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="">
                    ...
                    <img class="object-cover h-full p-4 rounded-3xl" src="{{asset('assets/images/logo/logo4.png')}}" alt="">
                </a>
            </li>
            <li>
                <a href="{{route('event.management')}}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-200 group">
